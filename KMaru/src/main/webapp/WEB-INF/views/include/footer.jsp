      ...
      <div class="container">
        <div class="d-flex align-items-center flex-wrap justify-content-between">
          ...
          <div class="payment-method">
            <p>Payment options :</p>
            <div class="card-wrap">
              <img src="${pageContext.request.contextPath }/resources/images/visa-icon.jpg" alt="visa">
              <img src="${pageContext.request.contextPath }/resources/images/mastercard.png" alt="mastercard">
              <img src="${pageContext.request.contextPath }/resources/images/american-express.jpg" alt="american-express">
            </div>
          </div>
        </div>
      </div>
